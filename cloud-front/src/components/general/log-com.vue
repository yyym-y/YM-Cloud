        ...
        <div class="text">登录账号</div>
          <form class="userInfo" @submit.prevent>
            <div class="Box">
              ...
              <input type="text" class="userName" placeholder="输入用户名" v-bind="userPut.UID">
            </div>
            <div class="Box">
            ...
            <a href="#" class="fogetPassword">忘记密码</a>
            <input type="submit" class="submitUserInfo Box" value="登录">
          </form>
            <button class="Box New">注册账号</button>
      </div>
    </div>
